...
class PersonaInfoSteps(BaseSteps):
    personal_info_button_path = (
        '//*[@id="root"]/div/div[3]/div/div[2]/div[1]/div/div[2]/a/div/a'
    )
    personal_data_header = '//*[@id="root"]/div/div[3]/div/div/h1'
    contacts_header = '//h1[@data-test-id="main-header"]'

    all_settings_button_path = (
        '//*[@id="root"]/div/div[3]/div/div[2]/div[2]/div/div[2]/a/div/a'
    )
    ...
    reserve_email_header_pop_up = (
        "/html/body/div[2]/div[2]/div/div/div[2]/form/div[1]/h1/span"
    )
    confirm_reserve_email_btn_path = (
        "/html/body/div[2]/div[2]/div/div/div[2]/form/button[1]/span"
    )
    input_reserver_email = (
        "/html/body/div[2]/div[2]/div/div/div[2]/form/div[4]/div/div/div/input"
    )
    result_email_span = (
        "/html/body/div[2]/div[2]/div/div/div[2]/form/div[4]/div[2]/small/span"
    )
    correct_email_header = "/html/body/div[2]/div[2]/div/div/div[2]/div/h1"
    delete_email_path = (
        '//*[@id="root"]/div/div[3]/div/div/div[12]/div/div[2]/div/div[3]/button'
    )
    confirm_delete_email_button = (
        "/html/body/div[2]/div[2]/div/div/div[2]/form/button[1]"
    )
    ...
    def insert_reserve_email(self, email):
        self.wait_until_and_get_elem_by_xpath(self.input_reserver_email).send_keys(
            email
        )
