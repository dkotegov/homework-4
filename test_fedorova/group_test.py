...
class GroupTest(BaseTest):
	...
	self.driver.refresh();
	self.assertTrue(all_groups_form.check_group_in_left(name))
	...
	self.assertTrue(my_groups_form.in_groups(group_name))
	...
	my_groups_page.open()
	my_groups_form = my_groups_page.form
	self.assertFalse(my_groups_form.in_groups(name))
	...
	my_groups_form = my_groups_page.form
	my_groups_form.moderation_groups()
	self.assertFalse(my_groups_form.in_groups(group_name))
