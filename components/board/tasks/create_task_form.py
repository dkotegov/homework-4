...
class CreateTaskForm(Component):
    ...
    CLOSE_BUTTON = None
    SUBMIT_BUTTON = None
    CLOSED_FORM = '//div[@class="task-list-add-task-button js-addNewTask"]'
    ...
    def __init__(self, driver: WebDriver, column_id: int):
        ...
        self.CLOSED_FORM = f'//div[@class="task-list-add-task-button js-addNewTask" and @data-column-id="{column_id}"]'
