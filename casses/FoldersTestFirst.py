...
class FoldersTest(unittest.TestCase):
    ...
    def test_select_top_folder(self):
        ...
        self.folderSteps.wait_folder("folder1")
        self.folderSteps.delete_folder("folder1")

    def test_select_check_incoming_folder(self):
        self.folderSteps.add_folder("folder2", "Входящие")  # OK
        self.folderSteps.wait_folder("folder2")
        self.folderSteps.delete_folder("folder2")

    def test_select_check_sent_folder(self):
        self.folderSteps.add_folder("folder3", "Отправленные")  # OK
        self.folderSteps.wait_folder("folder3")
        self.folderSteps.delete_folder("folder3")

    def test_select_drafts(self):
        self.folderSteps.add_folder("folder4", "Черновики")  # OK
        self.folderSteps.wait_folder("folder4")
        self.folderSteps.delete_folder("folder4")

    def test_pop3_check_box(self):
        self.folderSteps.add_folder("folder5", "", ["pop3"])  # OK
        self.folderSteps.wait_folder("folder5")
        self.folderSteps.delete_folder("folder5")

    def test_archive_check_box(self):
        self.folderSteps.add_folder("folder6", "", ["archive"])  # OK
        self.folderSteps.wait_folder("folder6")
        self.folderSteps.delete_folder("folder6")
    ...
    def test_folder_with_password(self):
        ...
        self.folderSteps.wait_folder("folder7")
        self.folderSteps.delete_folder("folder7", context["password"])  # OK

    def test_short_password(self):
        context = self.__password_context.copy()
        context["password"] = "ps"
        context["re_password"] = "ps"
        self.folderSteps.add_folder("folder8", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"]["invalidPassword"]
        )  # OK
    ...
    def test_long_password(self):
        ...
        self.folderSteps.add_folder("folder9", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"]["invalidPassword"]
        )  # OK
    ...
    def test_password_started_with_space(self):
        ...
        self.folderSteps.add_folder("folder10", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"]["invalidPassword"]
        )  # OK
    ...
    def test_password_ended_with_space(self):
        ...
        context["password"] = context["password"] + " "
        context["re_password"] = context["password"] + " "
        self.folderSteps.add_folder("folder11", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"]["invalidPassword"]
        )  # OK
    ...
    def test_invalid_password(self):
        ...
        context["re_password"] = context["password"]
        self.folderSteps.add_folder("folder12", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"]["invalidPassword"]
        )  # OK
    ...
    def test_invalid_re_password(self):
        ...
        self.folderSteps.add_folder("folder13", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"]["invalidRePassword"]
        )  # OK

    def test_missing_secret_question(self):
        context = self.__password_context.copy()
        context["question"] = ""
        self.folderSteps.add_folder("folder14", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"]["invalidSecretQuestion"]
        )  # OK

    def test_missing_secret_question_answer(self):
        context = self.__password_context.copy()
        context["question_answer"] = ""
        self.folderSteps.add_folder("folder15", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"][
                "invalidSecretQuestionAnswer"
            ]
        )  # OK
    ...
    def test_invalid_current_password(self):
        ...
        self.folderSteps.add_folder("folder16", "", ["has password"], context)
        self.assertTrue(
            self.folderSteps.get_form_errors()["passwordForm"]["invalidUserPassword"]
        )  # OK
