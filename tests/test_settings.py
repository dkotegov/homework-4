...
from pages.settings_components import Role, RoleRadioButtons
...
class ExampleTest(unittest.TestCase):
    ...
    # def test_forbidden_comments(self):
    ...
    #     self.assertTrue(self.group_page.open().comment_popup().is_disabled_leave_comment())
    #
    #     self.setting_page.open().to_management_page().forbid_leave_comments(WhoCanLeaveComments.MEMBERS)
    #     self.group_page_user_2.unjoin()
    #     self.assertTrue(self.group_page_user_2.open().comment_popup().is_disabled_leave_comment())
    #
    ...
    #     self.assertFalse(self.group_page_user_2.open().comment_popup().is_disabled_leave_comment())
