...
class CreateResume(unittest.TestCase):
    ...
    def test_enter_equal_salary(self):
        ...
        self.create_resume_form.submit()
        self.create_resume_form.wait_for_resume_page()
    ...
    # def test_enter_email_in_russian_letters(self):
    # !!!!!!ERRRRR!!!!!!!!!!!
    #     create_resume_without_submit(self.create_resume_form, self.data)
    #     self.create_resume_form.set_email("почта")
    #     self.create_resume_form.submit()
    #     self.assertTrue(self.create_resume_form.is_email_error())
    #
    # def test_enter_wrong_email_1(self):
    #     create_resume_without_submit(self.create_resume_form, self.data)
    #     self.create_resume_form.set_email("test")
    #     self.create_resume_form.submit()
    #     self.assertTrue(self.create_resume_form.is_email_error())
    # #
