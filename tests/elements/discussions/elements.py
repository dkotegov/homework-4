...
class Discussions(BaseElement):
    ...
    SCROLLTO = (By.XPATH, '/html/body/div[7]/div[9]/div[2]/div/div[1]/div/div[2]/div[2]/div[1]/div[1]/div/div[1]/div[2]/div[3]/div[2]/div[2]/div[1]/span')
    ...
    TIMEPANEL = (By.CSS_SELECTOR, '#d-id-cmnt-1511875975623--6929-rp > div:nth-child(2) > div:nth-child(1) > div:nth-child(2)')
