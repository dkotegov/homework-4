...
class ChangeDishSuccessTest(unittest.TestCase):
    ...
    def test_change_dish(self):
        first_dish_name = self.fake.first_name()
        second_dish_name = self.fake.first_name()
        ...
        self.assertNotIn(first_dish_name, dishes_name)
