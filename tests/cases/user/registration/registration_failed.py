...
class RegistrationFailedTest(unittest.TestCase):
    ...
    EMPTY_NAME_ERR_MESSAGE = "Имя пользователя: Поле должно быть заполнено"
    ...
    def test_empty_inputs(self):
        ...
        name_error = self.registration_page.get_name_error()
    ...
    def test_empty_email_input(self):
        ...
        self.registration_page.set_name(self.faker.name())
