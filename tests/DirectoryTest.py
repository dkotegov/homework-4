...
class DirectoryTest(BasicTest):
    ...
    def tearDown(self):
        if self.letter_subject != '':
            if 'Mail for archive' not in self.letter_subject and '$$$ Archive' not in self.letter_subject and 'The SOCIAL letter' not in self.letter_subject and 'not SOCIAL letter' not in self.letter_subject and 'The NewsLetter letter' not in self.letter_subject and 'Draft letter ' not in self.letter_subject:
