...
class PersonalDataTest(unittest.TestCase):
    ...
    # def test_load_avatar_icon_success(self):
    #     self.authorize()
    #
    #     personal_data_page = PersonalDataPage(self.driver)
    #     personal_data_page.open()
    #
    #     personal_data_page.form.load_avatar(self.PATH_TO_AVATAR)
    #     personal_data_page.form.save_avatar()
    #
    # def test_load_avatar_button_success(self):
    #     self.authorize()
    #
    #     personal_data_page = PersonalDataPage(self.driver)
    #     personal_data_page.open()
    #
    #     personal_data_page.form.load_avatar(self.PATH_TO_AVATAR, False)
    #     personal_data_page.form.save_avatar()
    ...
    # def test_load_avatar_icon_fail(self):
    #     self.authorize()
    #
    #     personal_data_page = PersonalDataPage(self.driver)
    #     personal_data_page.open()
    ...
    #     personal_data_page.form.save_avatar()
    #
    # def test_load_avatar_button_fail(self):
    #     self.authorize()
    #
    #     personal_data_page = PersonalDataPage(self.driver)
    #     personal_data_page.open()
